...
export function AppShell({
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-0.5 bg-ink px-4 py-1.5 text-center text-[11px] text-paper/90 print:hidden">
        <span className="font-semibold uppercase tracking-[0.12em] text-paper">
      ...
      <div className="flex min-h-screen flex-col">
        {/* Mobile top bar */}
        <header className="sticky top-0 z-20 flex items-center justify-between gap-3 border-b border-border bg-surface/95 px-4 py-3 backdrop-blur lg:hidden">
        ...
        {menuOpen && (
          <div id="mobile-nav" className="border-b border-border bg-surface px-4 py-4 lg:hidden">
